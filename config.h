...
#define FLAG_EXP		LTOR		// Modular exponentiation flag: LTOR, RTOL, MONTGOMERY

#define TEST_COUNT		10				// test를 실행할 횟수
#define TEST_SIZE		SIZE_1024		// Test를 실행할 byte size (SIZE_1024: 1024 bit, SIZE_2048: 2048 bit)
/* -------------------------------------------------------------------------------------------------------------- */
